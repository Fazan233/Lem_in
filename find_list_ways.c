...
void		show_hide_first_edge_ways2_test(t_min_way *min_way, int mode)
{
	while (min_way)
	{
...
void		show_hide_first_edge_ways2_test2(t_mas_ways *mas_ways, int mode)
{
	t_ways	*tmp;
...
t_ways		*find_list_ways2(t_lemin *lem, t_mas_ways *mas_ways)
{
	...
	ways = NULL;
	show_hide_first_edge_ways2_test(min_way, 0);
	while ((way = bfs(lem)))
	{
