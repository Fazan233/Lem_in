...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/18 13:02:25 by vuslysty          #+#    #+#             */
/*   Updated: 2019/03/18 13:04:10 by vuslysty         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		identical_way(t_way *way1, t_way *way2)
{
	t_way		*end;
...
static void		add_min_way(t_min_way **min_way, t_way *way)
{
	t_min_way	*new_mw;
